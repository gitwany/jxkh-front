...
import { MapKey, zoomEnable, dragEnable, MapCityName } from '@/config/config'
export default {
  props: ['lat', 'lng', 'dragMode'],
  data() {
    return {
      searchKey: '',
      placeSearch: null,
    ...
    initMap() {
      ...
      AMapUI.loadUI(['misc/PositionPicker'], PositionPicker => {
        ...
        const positionPicker = new PositionPicker({
          ...
          mode: this.dragMode, // 设定为拖拽地图模式，可选'dragMap'、'dragMarker'，默认为'dragMap'
          map // 依赖地图对象
        })
        // 拖拽完成发送自定义 drag 事件
